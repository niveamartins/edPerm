...
def data():
    try:
        ...
        Turma1 = Turma(id_responsavel=User2.Id, nome_do_curso="calculo",
                       carga_horaria_total=60, tolerancia=30, modalidade="n sei", turma_tag="tbm n sei")
        Turma2 = Turma(id_responsavel=User2.Id, nome_do_curso="iot", carga_horaria_total=60,
                       tolerancia=30, modalidade="n sei", turma_tag="tbm n sei")
